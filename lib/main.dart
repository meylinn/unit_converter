...
_resultMessage = _resultMessage;
    ...
    Widget build(BuildContext context) {
      final TextStyle inputStyle = TextStyle(
        fontSize: 20,
        color: Color.fromARGB(255, 44, 46, 50),
      );
      final TextStyle labelStyle = TextStyle(
        fontSize: 24,
        color: Color.fromARGB(255, 1, 189, 10),
      );
      return MaterialApp(
        ...
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 92, 152, 90),
      ),
        body: Container(
            ...
            Spacer(),
              ...
              Spacer(flex: 2,),
                ElevatedButton(
                  ...
                  style: ButtonStyle (
                  backgroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(255, 100, 202, 96),
                  ),
                  ),
                ),
              Spacer(flex: 2,),
